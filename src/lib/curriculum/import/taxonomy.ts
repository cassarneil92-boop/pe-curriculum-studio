...
export const TOPIC_PATTERNS: TopicPattern[] = [
  ...
  { topic: "Badminton", patterns: [/\bbadminton\b/i, /\(badminton\/tennis\)/i], priority: 100 },
  { topic: "Pickleball", patterns: [/\bpickleball\b/i, /\(pickleball\)/i], priority: 100 },
  { topic: "Touch Rugby", patterns: [/\btouch rugby\b/i], priority: 100 },
  { topic: "Tchoukball", patterns: [/\btchoukball\b/i], priority: 100 },
  { topic: "Ultimate Frisbee", patterns: [/\bultimate frisbee\b/i, /\bfrisbee\b/i, /\bdisc\b/i], priority: 95 },
  {
    topic: "Mini Tennis / Beach Racquet",
    patterns: [/\bmini tennis\b/i, /\bbeach racquet\b/i, /forehand stroke/i, /backhand stroke/i],
    priority: 95,
  },
  { topic: "Archery", patterns: [/\barchery\b/i, /\bbow\b/i, /\bdominant eye\b/i], priority: 95 },
  { topic: "Orienteering", patterns: [/\borienteering\b/i, /\bcompass\b/i, /\bmap\b/i], priority: 90 },
  { topic: "Trekking", patterns: [/\btrek(?:k?ing)?\b/i, /\b\d+\s*km\b/i], priority: 90 },
  { topic: "Team Building", patterns: [/\bteam building\b/i], priority: 85 },
  { topic: "Fundamentals", patterns: [/\bfundamentals\b/i], priority: 85 },
  {
    topic: "Holistic Development",
    patterns: [/\bholistic development\b/i, /\bHD\d/i],
    priority: 80,
  },
  {
...
export const TOPIC_DEFAULT_SKILLS: Partial<Record<CanonicalTopic, CanonicalSkill[]>> = {
  ...
  Badminton: ["Passing", "Movement"],
  Pickleball: ["Passing", "Movement"],
  "Touch Rugby": ["Passing", "Cooperation"],
  Tchoukball: ["Passing", "Cooperation"],
  Hockey: ["Passing", "Cooperation"],
  Fundamentals: ["Movement", "Coordination"],
  Orienteering: ["Movement", "Safety"],
  Trekking: ["Endurance", "Movement"],
  Archery: ["Shooting", "Safety"],
