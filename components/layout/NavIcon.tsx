...
export function NavIcon({ name }: { name: IconName }) {
  ...
  switch (name) {
    ...
    case "curriculum":
      return (
        <svg className={cls} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.148 0-2.313.22-3.405.634m9.763 2.066c1.147.365 2.193.96 3.045 1.737M12 6.042V3.75m0 2.292v13.5M12 6.042c1.148 0 2.313.22 3.405.634m-9.763 2.066C4.495 8.433 3.45 9.028 2.598 9.805M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      );
    case "analytics":
      return (
